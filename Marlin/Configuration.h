...
#define STRING_CONFIG_H_AUTHOR "(Doct0rDuc, FlsunQ5)" // Who made the changes.
...
#ifndef MOTHERBOARD
  //#define MOTHERBOARD BOARD_MKS_ROBIN_NANO_V1V2     //for the FLSUN Q5 maded before 2021 you need to decomment this line
  #define MOTHERBOARD BOARD_MKS_ROBIN_NANO_V1_3_F4    //if you don't know what motherboard version you have, you can open
                                                      //the top of the printer and check the mobo name
#endif
...
/* UART mode benefits:
    ...
    torque.
    4.Firmware can dynamically switch stepper motors between stealthChop2 and
    spreadCycle modes through UART.
    5.When the motor is not moving, the standby current of the motor can be reduced
    dynamically (through UART).

  if yuu don't know where are the UART pin for the singles driver
  here a video demostration https://www.youtube.com/watch?v=7ShcFKXrVHo
  (the video uses the robin nano v1.2, but the pin position are the same for the robin nano 1.3)
*/
#define TMC_HAS_UART      //if you are using TMC in UART uncomment the line below to set UART pin of the board
...
#define DELTA
  ...
  // !WARNING! this settings move the hotend down of ~ 6/7cm
  // if you print heigth object the hotend hit the printed object damaging it
  ...
  /*
  *
  * The setting down here are for stock FLSUN Q5, if you don't have
  *  this printer, please adjust those settings for you delta printer 
  *    
  */
...
#define Z_MIN_ENDSTOP_HIT_STATE LOW     //if you have some problem with
#define Z_MAX_ENDSTOP_HIT_STATE HIGH    //your probe adjust this two lines and line 1195
...
//FLSUN Q5 delta variables to calculate steps
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 410 }  // default steps per unit
 ...
 */
#define FIX_MOUNTED_PROBE       // stock probe for Q5
                                // yes the probe isn't really fix mounted on the Q5 (you can detach it), but
                                // this is the best settings for Q5 beacuse the "Magnetically Mounted Probe" isn't compatible for Q5
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -18 }
...
#define EXTRA_PROBING    1    //total of 3 probing time for one point
...
#define INVERT_E0_DIR false    // False for the stock Titan extruder, if you have changed extruder
#define INVERT_E1_DIR false    // and wwhen you use the "load filament" command the filament is actually
#define INVERT_E2_DIR false    // being unloaded change it to true for revert the direction
 ...
 * - Delta printer DON'T NEED THIS OPTION ENABLED
 */
