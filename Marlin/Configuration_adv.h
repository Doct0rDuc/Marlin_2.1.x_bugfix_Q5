...
// DELTA PRINTER DON'T NEED THIS SETTING
//#define SLOWDOWN
#if ENABLED(SLOWDOWN)
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z ( -17 )
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_4_GCODE "G28" //Modified .\Marlin\src\lcd\menu\menu_main.cpp(line154)
  #define MAIN_MENU_ITEM_4_CONFIRM

  #ifdef MPCTEMP
    #define MAIN_MENU_ITEM_5_DESC "1.Run Autotune on Active extruder"
    #define MAIN_MENU_ITEM_5_GCODE "M306T\nM500\nG28\nM107"
  #else
    #define MAIN_MENU_ITEM_5_DESC "1.Run PID_Nozzle_for " PREHEAT_1_LABEL
    #define MAIN_MENU_ITEM_5_GCODE "M106P0S180\nM303E0C8S210U\nM500\nG28\nM107\nM117 PID Tune Done"
  #endif
  #define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "Reboot Printer"
  #define MAIN_MENU_ITEM_6_GCODE "M997"
  #define MAIN_MENU_ITEM_6_CONFIRM

  #define MAIN_MENU_ITEM_7_DESC "1.Bed Level. UBL for " PREHEAT_1_LABEL
  #define MAIN_MENU_ITEM_7_GCODE "G29L1\nM1004B70S1"
  #define MAIN_MENU_ITEM_7_CONFIRM

  #define MAIN_MENU_ITEM_8_DESC "1.Print_Test_Pattern in " PREHEAT_1_LABEL
  #define MAIN_MENU_ITEM_8_GCODE "G28\nG29L1\nG26I0P4\nM500\nG28\nM117 Print Mesh Done"
  #define MAIN_MENU_ITEM_8_CONFIRM

  #define MAIN_MENU_ITEM_9_DESC "2.Bed Level. UBL for " PREHEAT_2_LABEL
  #define MAIN_MENU_ITEM_9_GCODE "G29L2\nM1004B80S2"
  #define MAIN_MENU_ITEM_9_CONFIRM

  #define MAIN_MENU_ITEM_10_DESC "1.Print_Test_Pattern in " PREHEAT_2_LABEL
  #define MAIN_MENU_ITEM_10_GCODE "G28\nG29L2\nG26I0P4\nM500\nG28\nM117 Print Mesh Done"
  #define MAIN_MENU_ITEM_10_CONFIRM

  #define MAIN_MENU_ITEM_11_DESC "3.Bed Level. UBL for " PREHEAT_3_LABEL
  #define MAIN_MENU_ITEM_11_GCODE "G29L3\nM1004B90S3"
  #define MAIN_MENU_ITEM_11_CONFIRM

  #define MAIN_MENU_ITEM_12_DESC "1.Print_Test_Pattern in " PREHEAT_3_LABEL
